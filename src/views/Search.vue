<template>
  <div class="search">
    <Header :isLeft="true" :title="'搜索'" push="/home"></Header>
    <div class="search_header">
      <form class="search_wrap">
        <i class="fa fa-search"></i>
        <input type="text" v-model="keyWord" placeholder="输入商家或商品信息" />
    ...
    <div class="shop" v-if="!showShop">
      ...
      <div v-else>
        <SearchIndex
          @shopClick="$router.push('/shop')"
          :data="result.restaurants"
        ></SearchIndex>
        <SearchIndex @shopClick="shopClick" :data="result.words"></SearchIndex>
      </div>
    </div>
